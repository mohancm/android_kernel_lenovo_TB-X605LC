...
/*Add by qiaoyufeng for M10X-1766 @2019/05/10 begin*/
static struct class *usbnet_card_class;
static CLASS_ATTR_STRING(plugin, 0444, "1");
/*Add by qiaoyufeng for M10X-1766 @2019/05/10 end*/
...
void usbnet_disconnect (struct usb_interface *intf)
{
	...
	free_netdev(net);
	/*Add by qiaoyufeng for M10X-1766 @2019/05/10 begin*/
	class_destroy(usbnet_card_class);
	/*Add by qiaoyufeng for M10X-1766 @2019/05/10 end*/
}
...
usbnet_probe (struct usb_interface *udev, const struct usb_device_id *prod)
{
	...
	/*Add by qiaoyufeng for M10X-1766 @2019/05/10 begin*/
	usbnet_card_class = class_create(THIS_MODULE, "usbnet_card");
	if (IS_ERR(usbnet_card_class)) {
		netdev_err(dev->net, "%s create usbnet_card class failed!\n", __func__);
	} else {
		int retval;
		retval = class_create_file(usbnet_card_class, &class_attr_plugin.attr);
		if (retval)
			netdev_err(dev->net, "%s can't create sysfs plugin file\n", __func__);
	}
	/*Add by qiaoyufeng for M10X-1766 @2019/05/10 end*/
	return 0;
