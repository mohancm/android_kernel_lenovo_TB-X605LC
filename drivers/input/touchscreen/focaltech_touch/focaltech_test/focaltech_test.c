...
static int fts_test_main_exit(void)
{
    ...
    ret = fts_test_save_test_data(FTS_TESTDATA_FILE_NAME, test_data.store_all_data, data_len);
    ret = fts_test_save_test_data(FTS_TESTRESULT_FILE_NAME, test_data.testresult, test_data.testresult_len);
...
static int fts_ito_test_show(struct seq_file *file, void* data)
{
    ...
    if((test_data.test_item[FT8201_ENTER_FACTORY_MODE].testresult))
    {
    ...
    //Rawdata result
    if ((test_data.test_item[FT8201_RAWDATA_TEST].testresult)
        &&(test_data.test_item[FT8201_CB_TEST].testresult))
    {
    ...
    //open test result
    if (test_data.test_item[FT8201_OPEN_TEST].testresult)
    {
    ...
    //short test result
    if(test_data.test_item[FT8201_SHORT_CIRCUIT_TEST].testresult)
    {
