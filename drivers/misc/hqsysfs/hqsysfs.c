...
static int __init create_sysfs(void)
{
	...
	/* add wifi/bt/fm/gps */
	hq_regiser_hw_info(HWID_WIFI,"WCN-3610-0-47WLNSP-HR-04-0");
	hq_regiser_hw_info(HWID_BT,"WCN-3610-0-47WLNSP-HR-04-0");
	hq_regiser_hw_info(HWID_FM,"WCN-3610-0-47WLNSP-HR-04-0C");
	hq_regiser_hw_info(HWID_GPS,"WGR7640");
